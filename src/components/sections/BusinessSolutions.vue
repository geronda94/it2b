...
const solutions = computed(() => [
  ...
  },
  {
    ...
    desc: t.value?.solutions?.web_desc || 'Заменяем медленный WordPress на молниеносные решения (Vue.js). Разрабатываем высококонверсионные лендинги, e-commerce и корпоративные порталы.'
  },
  {
    id: 'custom-erp',
  ...
  },
  {
    ...
    desc: t.value?.solutions?.api_desc || 'Разрабатываем отказоустойчивые API и серверную логику на современных технологиях (FastAPI). Обеспечиваем максимальную производительность при росте трафика.'
  }
])
</script>
